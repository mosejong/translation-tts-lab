...
생성형 AI API는 메인 로직이 아니라 미등록 용어 초안 추천, 라벨링 보조, 평가/검수 보조처럼 보조 역할로 제한했습니다.

## 프로젝트 목적

다문화 가정 학부모가 학교 가정통신문을 이해하고 바로 행동할 수 있도록, 한국어 안내문을 쉬운 한국어와 대상 언어 번역문, 음성 안내로 변환하는 파이프라인을 검증했습니다.

프로젝트의 초점은 "예쁜 번역 결과"보다 "서비스에서 틀리면 안 되는 정보가 보존되는가"였습니다. 그래서 사전학습 번역 모델 위에 학교 도메인 안전장치를 얹어, 백엔드와 앱에서 사용할 수 있는 입출력 구조를 만드는 데 집중했습니다.

## 핵심 성과

| 항목 | 결과 |
| --- | ---: |
| 프로젝트 평가 | `6개 팀 중 최우수상, 91.5점` |
| 학교 용어 보존 | `1/17 -> 17/17` |
